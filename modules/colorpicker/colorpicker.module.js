...
var SkyColorpickerModule = (function () {
    function SkyColorpickerModule() {
    }
    return SkyColorpickerModule;
}());
export { SkyColorpickerModule };
SkyColorpickerModule.decorators = [
    { type: NgModule, args: [{
                declarations: [
...
/** @nocollapse */
SkyColorpickerModule.ctorParameters = function () { return []; };
